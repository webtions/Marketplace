...
- Use code comments: Document your work
- Create a sane file structure. **Do** use includes to manage components sensibly. **Do not** use includes for every little snippet of code under the sun.
- Include a detailed ReadMe with information about the theme, its features, and where to go for help
...
We aren't trying to be mean about it. We're an extremely [small team](https://ghost.org/about/) with very limited resources. We do the best we can.
